		...
		<div id="panel-izquierdo">
			...
			?>
                                    ...
                                    <div class="<?=$classex?> <?=$Empresa['ftamano'] == 1 ? 'producto': ''?>" <?=$Empresa['ftamano'] == 1 ? 'style="border: 1px solid rgb(221, 221, 221);"': 'style="display: inline-block; border: 1px solid rgb(221, 221, 221);"'?>>
                                        ...
                                        <a href="<?=$draizp?>/<?=$_SESSION['lenguaje']?>/producto/<?=$productos[$i]['id']?>/<?=str_replace(".", "", str_replace("--", "-", $nombre))?>/"><img <?=$Empresa['ftamano'] == 1 ? 'class="zoom"': 'style="width: 100%;"'?> src="<?=$draizp?>/imagenesproductos/<?=$productos[$i]['imagen']?>" alt="<?=$productos[$i]['nombre']?>" /></a>
                                        <div class="descripcion2" style="min-height: 46px;"><a href="<?=$draizp?>/<?=$_SESSION['lenguaje']?>/producto/<?=$productos[$i]['id']?>/<?=str_replace(".", "", str_replace("--", "-", $nombre))?>/"><?=strlen($productos[$i]['nombre']) > 24 ? substr($productos[$i]['nombre'], 0, 47) : $productos[$i]['nombre'].'<br><br>'?></a></div>
                                        ...
                                        <?php if($_SESSION['usr'] != null || ($_SESSION['usr'] == null && $Empresa['registro'] == 1)){ ?>
                                            ...
                                            <br><div class="botoncito"><a class="vermas3" href="<?=$draizp?>/<?=$_SESSION['lenguaje']?>/producto/<?=$productos[$i]['id']?>/<?=str_replace(".", "", str_replace("--", "-", $nombre))?>/"><i class="fa fa-eye"></i> Ver más</a></div>
                                        <?php }else{ ?>
                                            <br><div class="botoncito"><a class="vermas3" style="width: 83% !important;max-width: 83% !important;text-align:center" href="<?=$draizp?>/<?=$_SESSION['lenguaje']?>/producto/<?=$productos[$i]['id']?>/<?=str_replace(".", "", str_replace("--", "-", $nombre))?>/"><i class="fa fa-eye"></i> Ver más</a></div>
                                        <?php } ?>
