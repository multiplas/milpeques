...
<div id="grupo-submenu"  style="width: 100%; -webkit-box-shadow: 0px 7px 11px 0px rgba(50, 50, 50, 0.4);-moz-box-shadow: 0px 7px 11px 0px rgba(50, 50, 50, 0.4);box-shadow: 0px 7px 11px 0px rgba(50, 50, 50, 0.4); min-height: 75px;">
	...
	<div id="submenu" style="top: 50%; -ms-transform: translateY(25%); -webkit-transform: translateY(25%); transform: translateY(25%); font-family: <?=$fuente1?>,sans-serif;">
		<ul>
                    <li style="float: left" id="casita" class="divLogo2"><a href="<?=$draizp?>/<?=$_SESSION['lenguaje']?>"><i class="fa fa-home fa-lg"></i></a></li>
                        <?php if($logoMenu != ''){ ?><li style="float: left" id="logo_fijo" class="divLogo"><a href="<?=$draizp?>/<?=$_SESSION['lenguaje']?>"><img id="logo_fijo2" class="imagenMenu2" src="<?=$draizp?>/source/<?=$logoMenu?>" alt=""/></a></li>
                        <?php }else{ ?><li style="float: left" id="logo_fijo" class="divLogo"><a href="<?=$draizp?>/<?=$_SESSION['lenguaje']?>"><i class="fa fa-home fa-lg"></i></a></li><?php } ?>
			<?php
                $control = 0;
			...
			<?php
				}else if ($control == 5){ echo '<li onmouseover="mostrar();" onmouseout="ocultar();" style="font-weight:bold; float:left"><a href="#"><span style="width:15px;height:15px;background-image: url('.$draizp.'/source/th.png);margin-top:15px;"></span>&nbsp;Otros productos</a></li>'; $control++; 
                                
                                ?> <div id="superflotante" onmouseover="mostrar();" onmouseout="ocultar();" class="bloque_submenu" style="margin-top: 45px !important; display:none; background-color: #ffffff; -webkit-box-shadow: 0px 7px 11px 0px rgba(50, 50, 50, 0.4);-moz-box-shadow: 0px 7px 11px 0px rgba(50, 50, 50, 0.4);box-shadow: 0px 7px 11px 0px rgba(50, 50, 50, 0.4);">
				<?php
                    $cnt = 0;
                    $cntall = 0;
            ...
            <?php if($Empresa['blog'] == 1){ ?>
                <li style="float: left"><a href="<?=$draizp?>/<?=$_SESSION['lenguaje']?>blog"><?=$Empresa['nblog']?></a></li>
            <?php } 
                if($Empresa['galeria'] == 1){
            ?>
                <li style="float: left"><a href="<?=$draizp?>/<?=$_SESSION['lenguaje']?>galeria"><?=$Empresa['ngaleria']?></a></li>
            <?php } ?>
