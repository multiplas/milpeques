	...
	<div class="muestra" style="text-align: center">
		...
		?>
				<div id='producto_<?=$i?>' class="<?=$Empresa['ftamano'] == 1 ? 'producto': ''?>" style="border: none !important; -webkit-animation-delay: <?=$i*0.2?>s; -moz-animation-delay: <?=$i*0.2?>s; width: 100% !important">
                                    ...
                                    <span class="descripcion" style="width: 100%"><?php if ($Empresa['det_producto'] == 1){ ?><a href="<?=$draizp?>/<?=$_SESSION['lenguaje']?>producto/<?=$productosMN[$i]['id']?>/<?=str_replace("--", "-", $nombre)?>/"><?php } ?><?=$productosMN[$i]['nombre']?><?php if ($Empresa['det_producto'] == 1){ ?></a><?php } ?></span>
                    ...
                    <?php if($_SESSION['usr'] != null || ($_SESSION['usr'] == null && $Empresa['registro'] == 1)){ ?>
                        ...
                        <?php if($Empresa['actPre'] == 1){ ?><?php if ($Empresa['det_producto'] == 1){ ?><span class="precio"><?=$productosMN[$i]['tprecio'] != '' ? $productosMN[$i]['tprecio'] : ($productosMN[$i]['precio'] != 'Consultar' ? number_format(ConvertirMoneda($Empresa['moneda'],$_SESSION['divisa'],$productosMN[$i]['precio']), 2, ',', '.') : 'Consultar')?><?=$productosMN[$i]['precio'] != 'Consultar' ? $productosMN[$i]['tprecio'] != '' ? '' : $_SESSION['moneda'] : ''?></span><br><br><?php } } ?>
