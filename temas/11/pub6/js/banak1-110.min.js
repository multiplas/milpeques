...
function start_slider(){function e(){$(".slider_imagenes .slide.current").index()===$(".slider_imagenes .slide").length-1?t=0:t++,n(t)}function i(){0===$(".slider_imagenes .slide.current").index()?t=$(".slider_imagenes .slide").length-1:t--,n(t)}function n(e){val=100/$(".slider_imagenes .slide").length*e,$(".slider_imagenes .slide").removeClass("current"),$(".slider_imagenes .pagination .page").removeClass("current"),0===e?($(".slider_imagenes .slide:first-child").addClass("current"),$(".slider_imagenes .pagination .page:first-child").addClass("current")):($(".slider_imagenes .slide:nth-child("+(e+1)+")").addClass("current"),$(".slider_imagenes .pagination .page:nth-child("+(e+1)+")").addClass("current")),$(".slider_imagenes").removeClass("desapareciendo"),$(".slider_imagenes").removeClass("apareciendo"),$(".slider_imagenes").addClass("desapareciendo"),setTimeout(function(){$(".slider_imagenes .slide:first-child").css("margin-left","-"+val+"%"),setTimeout(function(){$(".slider_imagenes").addClass("apareciendo")},800)},800)}var t=0;widthslider=100/$(".slider_imagenes .slide").length,$(".slider_imagenes .sliders").css("width",100*$(".slider_imagenes .slide").length+"%"),$(".slider_imagenes .slide").css("width",widthslider+"%"),automove=setInterval(e,6e3),$(".slider_imagenes .slide").each(function(){$(".slider_imagenes .pagination").append('<div class="page"></div>')}),$(".flechas .right").click(function(){e(),clearInterval(automove)}),$(".flechas .left").click(function(){i(),clearInterval(automove)}),$(".slider_imagenes .pagination .page").click(function(){t=$(this).index(),clearInterval(automove),n(t)})}function slider_products(){function e(){i=$(window).width()>=1621?4:$(window).width()>=768?3:$(window).width()>=560?2:1}var i;e(),$(".list_products[data-slider='on']").each(function(){for(var e=1;i+1>e;e++)$(this).children(".block_product_unic:nth-child("+e+")").addClass("current")}),$(window).resize(function(){$(".list_products[data-slider='on']").each(function(){e(),$(this).children(".block_product_unic").removeClass("current");for(var n=1;i+1>n;n++)$(this).children(".block_product_unic:nth-child("+n+")").addClass("current")})}),$(".products_home .flechas .right_arrow").click(function(){myclick=$(this),moveslider(myclick,"right")}),$(".products_home .flechas .left_arrow").click(function(){myclick=$(this),moveslider(myclick,"left")})}function moveslider(e,i){"left"===i?$(e.parent().siblings(".list_products.current").children(".block_product_unic.current").get().reverse()).each(function(e,i){time=150+150*e,setTimeout(function(){$(i).addClass("desapareciendo")},time)}):e.parent().siblings(".list_products.current").children(".block_product_unic.current").each(function(e,i){time=150+150*e,setTimeout(function(){$(i).addClass("desapareciendo")},time)}),time+=300,setTimeout(function(){"right"===i?(console.log("next"),e.parent().siblings(".list_products.current").children(".block_product_unic.current").each(function(i,n){nextcurrent=$(n).nextAll(".block_product_unic").not(".current").first(),0!==nextcurrent.length?nextcurrent.addClass("current opacity_zero"):e.parent().siblings(".list_products.current").children(".block_product_unic").not(".current").first().addClass("current opacity_zero"),$(n).removeClass("current desapareciendo"),e.parent().siblings(".list_products.current").append($(n))})):"left"===i&&(console.log("back"),$(e.parent().siblings(".list_products.current").children(".block_product_unic.current").get().reverse()).each(function(i,n){backcurrent=$(n).nextAll(".block_product_unic").not(".current").last(),backcurrent.addClass("current opacity_zero"),console.log($(n)),e.parent().siblings(".list_products.current").prepend($(n)),$(n).removeClass("current desapareciendo")}),e.parent().siblings(".list_products.current").children(".block_product_unic").each(function(i,n){return $(n).hasClass("current")?!1:void e.parent().siblings(".list_products.current").append($(n))})),"left"===i?$(e.parent().siblings(".list_products.current").children(".block_product_unic.current").get().reverse()).each(function(e,i){time=150*e,setTimeout(function(){$(i).removeClass("opacity_zero").addClass("apareciendo")},time),setTimeout(function(){$(i).removeClass("apareciendo")},time+300)}):e.parent().siblings(".list_products.current").children(".block_product_unic.current").each(function(e,i){time=150*e,setTimeout(function(){$(i).removeClass("opacity_zero").addClass("apareciendo")},time),setTimeout(function(){$(i).removeClass("apareciendo")},time+300)})},time)}function change_slider(e){mydata=e.data("slidername"),e.parents(".container_base").find(".list_products").removeClass("current"),e.parents(".container_base").find('.list_products[data-slidername="'+mydata+'"]').addClass("current"),e.addClass("current"),e.siblings().removeClass("current")}$(document).ready(function(){$("[data-enlace]").click(function(){"_blank"===$(this).data("target")?window.open($(this).data("enlace"),"_blank"):window.location=$(this).data("enlace")}),$("body").on("click","div [data-enlace]",function(){"_blank"===$(this).data("target")?window.open($(this).data("enlace"),"_blank"):window.location=$(this).data("enlace")}),$("header .languages .option").click(function(e){e.stopPropagation(),$(this).siblings(".option").children(".hidden_opt").slideUp(),$(this).children(".hidden_opt").slideToggle()}),$("body").click(function(){$(".hidden_opt").slideUp(),$("header .information-nav .search_block").removeClass("active")}),$("header .information-nav .search_block .buscador").click(function(e){e.stopPropagation(),$(this).parents(".search_block").addClass("active")}),$(".slider_imagenes").length&&start_slider(),$(".list_products[data-slider='on']").length&&slider_products(),$(".products_home .option_cat").click(function(){change_slider($(this))}),$(".block_categories .option_cat_li").click(function(){$(this).parents(".content-box-perso").children(".content-desp").slideToggle(),change_slider($(this))}),$(".info_producto_v .bloquepestanas .label").click(function(){$(".info_producto_v .bloquepestanas .label").removeClass("current"),$(".info_producto_v .bloquepestanas .content_label").removeClass("current"),$(this).addClass("current"),$('.info_producto_v .bloquepestanas .content_label[data-option="'+$(this).data("option")+'"]').addClass("current")}),$(".miniaturas img").click(function(){$(".column.imgs .galeria img").attr("src",$(this).data("image"))}),$(".miniaturas .flechas .left_arrow").click(function(){$(".miniaturas").prepend($(".miniaturas img:nth-last-child(2)"))}),$(".miniaturas .flechas .right_arrow").click(function(){$(".miniaturas").append($(".miniaturas img:first-child")),$(".miniaturas").append($(".miniaturas .flechas"))}),$(".openmenu_responsive").click(function(){$("body").toggleClass("openmenuresponsive")}),$("header .menu-nav .menu-navigation .isparent a, header .menu-nav .menu-navigation .isparent").click(function(e){return $(this).toggleClass("menuopened"),e.stopPropagation(),null!=$(this).attr("href")&&(window.location.href=$(this).attr("href")),!1}),$(".go_top_button").click(function(){$("html, body").animate({scrollTop:0},"slow")})});
function BanakIrURL(a){""!=a&&window.location.assign(a)}function BanakMensaje(a,e,n,s,t){var o="INFO";""!=e&&(o=e);var c="OK";""!=s&&(c=s),$("#BanakMensaje").html(n),$("#BanakMensaje").dialog({modal:!0,title:o,width:600,minWidth:400,show:"fold",hide:"scale",close:function(a,e){BanakIrURL(t)},buttons:[{text:c,click:function(){$(this).dialog("close")}}]})}function BanakAjaxMensaje(a,e){$.ajax({url:a,global:!0,type:"POST",timeout:1e4,data:e,dataType:"json",async:!1,success:function(a){var e="",n="",s="",t="",o="OK",c="",i=0;$.each(a,function(a,n){switch(a){case"OK":e=n;break;case"Titulo":s=n;break;case"Mensaje":t=n;break;case"Boton":o=n;break;case"Url":c=n;break;case"NoMensaje":i=n}}),0==i?(n="OK"==e?"INFO":"ERROR",BanakMensaje(n,s,t,o,c)):""!=c&&BanakIrURL(c)}})}
function ImagenesFondo(){$(".data_fondo").each(function(){var a;a=$(window).width()>1220?$(this).data("fondo"):$(window).width()>767?$(this).data("fondo1"):$(window).width()>560?$(this).data("fondo2"):$(this).data("fondo3"),$(this).css("background-image","url("+a+")")})}function elementoalavista(a){var e=!0,t=$(document).scrollTop(),r=t+window.innerHeight,o=a.offset().top,i=o+a.height();return(o>=r||t>=i)&&(e=!1),e}function verMasRegistros(a){var e=$(a),t=e.data("mrajaxurl"),r=e.data("mrajaxparam"),o=e.data("mrhistory");e.remove(),$.ajax({url:t,global:!1,type:"GET",data:r,dataType:"html",async:!0,success:function(a){$("#finregistros").before(a),window.history.replaceState(null,null,o)}}).responseText}function cambiaacabado(a,e){e="#"+e;var t=$(e+" option:selected").val(),r=$("#cdn_pub").html();a="#"+a,$(a).empty().html('<img style="margin:20px 0px 0px 0px;" src="'+r+'pub6/images/cambia_acabado_loading.gif" alt="Cargando" />'),$(a).load("/amp_producto.acabados.php",{mat:t})}function cambiaprecio(){for(var a=document.getElementById("n_gamas").value,e=document.getElementById("id_articulo").value,t="",r="",o=$("#cdn_pub").html(),i=1;a>=i;i++)null!=document.getElementById("id_gama"+i)&&(t+=r+document.getElementById("id_gama"+i).value+"-"+document.getElementById("select"+i).value,r="-");$("#precio-ajax").html('<img src="'+o+'pub6/images/cambia_precio_loading.gif" alt="Cargando" />'),$.ajax({url:"/amp_producto.precios.php",global:!1,type:"POST",data:{acabados:t,id_articulo:e},dataType:"html",async:!0,success:function(a){$("#precio-ajax").html(a)}}).responseText}function CuentaAtras(){var a=parseInt($(".bloquetime .ca_eje").text()),e=parseInt($(".bloquetime .ca_mes").text()),t=parseInt($(".bloquetime .ca_dia").text()),r=new Date(a,e-1,t),o=new Date,i=0,l=0,n=0,s=0;if(r>o){var u=(r.getTime()-o.getTime())/1e3;i=Math.floor(u/86400),u-=86400*i,l=Math.floor(u/3600),u-=3600*l,n=Math.floor(u/60),u-=60*n,s=Math.floor(u),$(".bloquetime .blocktime.day .cifra").text(i),$(".bloquetime .blocktime.hours .cifra").text(l),$(".bloquetime .blocktime.min .cifra").text(n),$(".bloquetime .blocktime.secs .cifra").text(s),(i>0||l>0||n>0||s>0)&&setTimeout("CuentaAtras()",1e3)}else console.log("a"),$(".bloquetime .blocktime.day .cifra").text(i),$(".bloquetime .blocktime.hours .cifra").text(l),$(".bloquetime .blocktime.min .cifra").text(n),$(".bloquetime .blocktime.secs .cifra").text(s)}function AgregarArticuloCesta(){$("#guardar_cookies").val(navigator.cookieEnabled);var a="/mi_cesta.add.php",e=$("#producto-formulario").serialize();BanakAjaxMensaje(a,e)}function AgregarCesta(a){$("#head_guardar_cookies").val(navigator.cookieEnabled),$("#head_id_articulo").val(a);var e="/mi_cesta.add.php",t=$("#head-cesta-formulario").serialize();BanakAjaxMensaje(e,t)}function activafiltrospvp(){$("#slider-range").slider({range:!0,step:$("#slider-range").data("step"),min:$("#slider-range").data("min"),max:$("#slider-range").data("max"),values:[$("#slider-range").data("val0"),$("#slider-range").data("val1")],tooltip:"always",slide:function(a,e){$("#amount").val($.formatNumber(e.values[0],{format:"#,##0€",locale:"es"})+" - "+$.formatNumber(e.values[1],{format:"#,##0€",locale:"es"}))},stop:function(a,e){var t=$("#slider-range").data("param")+"&pvp_mayor="+e.values[0]+"&pvp_menor="+e.values[1];cambiaresultadobusqueda(t)}}),$("#amount").val($.formatNumber($("#slider-range").slider("values",0),{format:"#,##0€",locale:"es"})+" - "+$.formatNumber($("#slider-range").slider("values",1),{format:"#,##0€",locale:"es"})),$(".desplegableselected").click(function(){$(this).siblings(".content-box-perso").children(".content-desp").slideToggle()})}function cambiaresultadobusqueda(a){$.ajax({url:"/busqueda.resultado.php",global:!0,type:"GET",timeout:1e4,data:a,dataType:"html",async:!0,success:function(e){$("#div-resultado-ajax").html(e),activafiltrospvp(),ImagenesFondo();var t="/busqueda?"+a+"&p=1";window.history.replaceState(null,null,t)}}).responseText}function LoginEntrada(){$("#guardar_cookies").val(navigator.cookieEnabled);var a="/login.entrar.php",e=$("#login-formulario").serialize();BanakAjaxMensaje(a,e)}function UOEmail(){var a="/usuario_olvide_contrasena.email.php",e=$("#uo-formulario").serialize();BanakAjaxMensaje(a,e)}function UBGraba(){var a="/usuario_baja.grabar.php",e=$("#ub-formulario").serialize();BanakAjaxMensaje(a,e)}function UMGrabarEmail(){var a=$("#um-actual").val(),e=$("#um-email").val(),t=$("#um-email2").val();if(a==e){var r=$("#um-error1").html();return void BanakMensaje("ERROR","Error",r,"","")}if(e!=t){var o=$("#um-error2").html();return void BanakMensaje("ERROR","Error",o,"","")}var i="/usuario_modificar.email.php",l=$("#um-formulario").serialize();BanakAjaxMensaje(i,l)}function UMGrabarPassword(){var a=$("#um-actual").val(),e=$("#um-pass").val(),t=$("#um-pass2").val();if(a==e){var r=$("#um-error1").html();return void BanakMensaje("ERROR","Error",r,"","")}if(e!=t){var o=$("#um-error2").html();return void BanakMensaje("ERROR","Error",o,"","")}var i="/usuario_modificar.password.php",l=$("#um-formulario").serialize();BanakAjaxMensaje(i,l)}
!function(t){t(function(){ImagenesFondo()}),t(function(){t(document).tooltip()}),t(function(){t(".miquerydd").msDropDown()}),t(function(){t(".bloquetime").each(function(){CuentaAtras()})}),t(function(){t("#mensaje-auto").each(function(){var n=t("#mensaje-auto-tipo").text(),e=t("#mensaje-auto-titulo").text(),o=t("#mensaje-auto-mensaje").html(),a=t("#mensaje-auto-boton").text(),i=t("#mensaje-auto-url").text();BanakMensaje(n,e,o,a,i)})}),t(function(){t("div.masregistros.clearfix").each(function(){t(window).on("scroll resize",function(){var n="div.masregistros.clearfix";t(n).length&&elementoalavista(t(n))&&verMasRegistros(n)})})}),t(function(){activafiltrospvp()}),t(function(){t(".contadortiempo").append(" (width: "+t(window).width()+"px)")})}(jQuery);
