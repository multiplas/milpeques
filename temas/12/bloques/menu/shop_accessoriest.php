                                                        ...
                                                        <div class="ruby-row">
                                                                ...
                                                                ?>
                                                                    <div class="ruby-col-3">
                                                                        <img src="<?=$hijo2['imagen'] != '' ? $draizp.'/imagenesproductos/'.$hijo2['imagen'] : 'http://placehold.it/300x150'?>">
                                                ...
                                                <?php if (count($padre['categorias']) > 0 && $padre['categorias'] != null){ ?>
                                                    <div class="ruby-grid ruby-grid-lined">
                                                        <div class="ruby-row">
                                                                ...
                                                                ?>
                                                                        <div class="ruby-col-3">
                                                                        <img src="<?=$hijo1['imagen'] != '' ? $draizp.'/imagenesproductos/'.$hijo1['imagen'] : 'http://placehold.it/300x150'?>">
