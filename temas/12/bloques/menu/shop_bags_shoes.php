                                                    ...
                                                    <div class="ruby-grid ruby-grid-lined">
                                                        <div class="ruby-row">
                                                                ...
                                                                foreach ($hijo1['categorias'] AS $hijo2){
                                                                    ...
                                                                    if($contadorImg%2 == 0){ ?>
                                                                        <div class="ruby-col-3" style="height: 220px">
                                                                            <img style="max-height: 190px; width: 100%;" src="<?=$hijo2['imagen'] != '' ? $draizp.'/imagenesproductos/'.$hijo2['imagen'] : 'http://placehold.it/292x268'?>">
                                                                        </div>
                                                                    <?php } ?>
                                                    ...
                                                    <div class="ruby-grid ruby-grid-lined">
                                                        <div class="ruby-row">
                                                                ...
                                                                foreach ($padre['categorias'] AS $hijo1){
                                                                    ...
                                                                    if($contadorImg%2 == 0){ ?>
                                                                        <div class="ruby-col-3" style="height: 220px">
                                                                            <img style="max-height: 190px; width: 100%;" src="<?=$hijo1['imagen'] != '' ? $draizp.'/imagenesproductos/'.$hijo1['imagen'] : 'http://placehold.it/292x268'?>">
                                                                        </div>
                                                                    <?php } ?>
                                                                    <div class="ruby-col-3">
                                                                        <h3 class="ruby-list-heading"><a <?=$hijo1['url'] != '' ? 'target="_blank"' : ''?> href="<?=$hijo1['url'] == '' ? $draizp.'/'.$_SESSION['lenguaje'].'productos/'.$hijo1['id'].'/'.$nombre3.'/' : $hijo1['url']?>"><?=$hijo1['nombre']?></a></h3>
                                                                        <?php if (count($hijo1['categorias']) > 0 && $hijo1['categorias'] != null){
                                                                            $nombre3 = utf8_encode(strtr(utf8_decode($hijo2['nombre']), utf8_decode($tofind), $replac));
                                                                            $nombre3 = strtolower($nombre3);
                                                                            $nombre3 = preg_replace('([^A-Za-z0-9])', '-', $nombre3);	
