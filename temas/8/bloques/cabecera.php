...
<div id="cabecera" style="z-index: 1000000"">
    ...
    <?php
    echo "<div style='margin-top: 0px; text-align: right;'>";
    ?>
        ...
        <div class="movil_bien" style="float:left; margin-top: -35px;">Bienvenid@ <?=substr($_SESSION['usr']['nombre'], 0, 36)?>&nbsp;</div><br> 
        
</div>
    <div id="logo" style="float: left; width: 20%; margin-top: -30px; margin-bottom: -22px;">
                <?php if($logoSup != ''){ ?><a href="<?=$draizp?>/<?=$_SESSION['lenguaje']?>/"><img src="<?=$draizp?>/source/<?=$logoSup?>" alt="" style="max-height: 150px; width: 100% !important; max-width: 200px" /></a><?php } ?>
	</div>
    <div id="imagen_cab" style="float: left; width: 79%; margin-top: -30px; margin-bottom: -22px;">
		<a href="<?=$draizp?>/<?=$_SESSION['lenguaje']?>/"><img src="<?=$draizp?>/source/cabecera_1.png" alt="" style="max-height: 150px; max-width: 846px; width: 100%;" /></a>
	</div>
