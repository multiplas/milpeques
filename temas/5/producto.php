                                ...
                                <?php
                                    ...
                                    foreach ($atributos AS $atributo){ 
                                        ...
                                        if($atributo['nombre'] != $aux && $c == 0){ ?>
                                            <script>
                                                $(document).on("change", "#<?=$nombreJS?>", function(){  
                                                    $.post("/ajax/precio.php", {id: <?=$producto['id']?>, valor: $( "#<?=$nombreJS?>" ).val(), moneda1: '<?=$Empresa['moneda']?>', moneda2: '<?=$_SESSION['divisa']?>' }, function(respuesta){ 
                                                        var temp = respuesta;
                                                        temp = temp.split("-");
                                                        if(temp['0'] == 't'){
                                                            var tot = $('#totalspan').attr('data-precio');
                                                            var tot2 = $('#totalspan').attr('data-preciobase');
                                                            var dif = parseFloat(tot) - (parseFloat(tot2) + parseFloat($("#<?=$nombreJS?>").attr('data-precio')));
                                                            var precioAnt = parseFloat(tot) - parseFloat($("#<?=$nombreJS?>").attr('data-precio'));
                                                            ...
                                                            $("#<?=$nombreJS?>").attr('data-precio', precioAnt);
                                                            ...
                                                            var tot = $('#totalspan').attr('data-precio');
                                                            tot = parseFloat(tot) - parseFloat($("#<?=$nombreJS?>").attr('data-precio'));
                                                            if($( "#<?=$nombreJS?>" ).val() != '')
                                                                tot = tot + parseFloat(temp['1']);
                                                            $("#<?=$nombreJS?>").attr('data-precio', temp['1']);
                                                            $('#totalspan').attr('data-precio', tot);
                                                            tot = tot.toFixed(2);
                                                            tot = tot.replace(",","/");
                                                            tot = tot.replace(".",",");
                                                    ...
                                                    $.post("/ajax/foto.php", {id: <?=$producto['id']?>, valor: $( "#<?=$nombreJS?>" ).val()}, function(respuesta){ 
                                                        if(respuesta != ''){
                                    ...
                                    $( "#fentrada" ).datepicker({
                                        ...
                                        onSelect: function(dateText) { 
                                            ...
                                            if(fechaEntrada >= hoy){
                                                ...
                                                if($('#fsalida').val() != ""){
                                                        $.post("/ajax/precio_esp.php", {id: <?=$producto['id']?>, valor: $( "#<?=$nombreJS?>" ).val(), fentrada: $( "#fentrada" ).val(), fsalida: $( "#fsalida" ).val(), moneda1: '<?=$Empresa['moneda']?>', moneda2: '<?=$_SESSION['divisa']?>' }, function(respuesta){ 
                                                            if(respuesta != "- " && respuesta != "--"){
                                                                ...
                                                                //$("#<?=$nombreJS?>").attr('data-precio', respuesta);
                                                                //$('#totalspan').attr('data-precio', tot);
                                                                tot = tot.toFixed(2);
                                                                tot = tot.replace(",","/");
                                                                tot = tot.replace(".",",");
