                    ...
                    <script>
                        $(document).on("scroll", function(){
                            ...
                            if(desplazamientoActual >= <?=$medida1?>){
                                $('#textos').attr('style', 'padding: 0px 15px;width: 45%;display: inline; margin-right:2%; float: right; position: relative; top: 25px;  margin-bottom: 25px; -ms-transform: translateY(-50%); -webkit-transform: translateY(-50%); transform: translateY(-50%);');
                                $('#textos').addClass('animated bounceInLeft');
                                $('#textos2').attr('style', 'padding: 0px 15px;width: 45%; margin-left:2%; position: relative; top: 25px; margin-bottom: 25px; -ms-transform: translateY(-50%); -webkit-transform: translateY(-50%); transform: translateY(-50%);');
                    ...
                    <script>
                        $(document).ready(function(){
                            ...
                            if(ventana_ancho > 940){
                                ...
                                $("#izquierda").attr('style', 'width: 50%; background-color: #e36b6b; color: #ffffff; float:left; height: 100%; background: rgba(227, 107, 107, 1) url(/imagenes/fondo.jpg) no-repeat scroll right center; padding-bottom: 25px;');
                            }
                        });
                    </script>
