...
$permitidas= array ("a","e","i","o","u","A","E","I","O","U","n","N","A","E","I","O","U","a","e","i","o","u","c","C","a","e","i","o","u","A","E","I","O","U","u","o","O","i","a","e","U","I","A","E");
			...
			?>
                                    ...
                                    <div class="<?=$classex?> <?=$Empresa['ftamano'] == 1 ? 'producto': ''?>" <?=$Empresa['ftamano'] == 1 ? 'style="border: 1px solid rgb(221, 221, 221);"': 'style="display: inline-block; border: 1px solid rgb(221, 221, 221);"'?>>
                                        ...
                                        <?=$productos[$i]['mostraretqOfe'] == 0 ? ($productos[$i]['descuento'] != 0 ?  ($Empresa['actDes'] == 1 ? '<span class="sale-label"> -'.$productos[$i]['descuento'].'% </span>' : '<span class="sale-label" style="height:20px; background-color: transparent"></span>') : '<span class="sale-label" style="height:20px; background-color: transparent"></span>') : '' ?>
