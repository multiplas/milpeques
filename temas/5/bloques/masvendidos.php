...
<style>
	...
	<div class="muestra" style="text-align: center">
		...
		?>
				<div id='productoMV_<?=$i?>' class="producto" style="border: 1px solid rgb(221, 221, 221); padding: 15px; -webkit-animation-delay: <?=$i*0.2?>s; -moz-animation-delay: <?=$i*0.2?>s; visibility: hidden">
