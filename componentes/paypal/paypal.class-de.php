...
class paypal_class {
   ...
   function submit_paypal_post() {
      ...
      echo "<html>\n";
      echo "<head><title>PayPal-Zahlungsprozess ...</title></head>\n";
      echo "<body onLoad=\"document.forms['paypal_form'].submit();\">\n";
      echo "<center><h3>Einen Moment bitte, Ihre Anfrage wird bearbeitet ";
      echo "Wir werden Ihre Anfrage zu PayPal umgeleitet werden.</h3></center>\n";
      ...
      echo "<center><br/><br/>Wenn nicht redirect";
      echo "Paypal in 5 Sekunden ...<br/><br/>\n";
      echo "<input id=\"submitButton\" type=\"submit\" value=\"Klicken Sie hier\" class=\"btnLilaAuto\"></center>\n";
      echo "</form>\n";
      echo "</body></html>\n";
