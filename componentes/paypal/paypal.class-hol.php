...
class paypal_class {
   ...
   function submit_paypal_post() {
      ...
      echo "<html>\n";
      echo "<head><title>PayPal betaling te verwerken...</title></head>\n";
      echo "<body onLoad=\"document.forms['paypal_form'].submit();\">\n";
      echo "<center><h2>Even geduld aub, uw aanvraag wordt verwerkt ";
       echo "wij zullen uw verzoek om PayPal te leiden.</h2></center>\n";
      ...
      echo "<center><br/><br/>Zo niet omleiden naar ";
       echo "Paypal in 5 seconden ...<br/><br/>\n";
      echo "<input type=\"submit\" class=\"btnLilaAuto\" value=\"Klik hier\"></center>\n";
