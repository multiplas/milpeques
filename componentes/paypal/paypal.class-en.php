...
class paypal_class {
   ...
   function submit_paypal_post() {
      ...
      echo "<html>\n";
      echo "<head><title>PayPal payment process ...</title></head>\n";
      echo "<body onLoad=\"document.forms['paypal_form'].submit();\">\n";
      echo "<center><h2>One moment please, your request is being processed";
      echo " we will redirect your request to PayPal.</h2></center>\n";
      ...
      echo "<center><br/><br/>If not redirect to ";
       echo "Paypal in 5 seconds...<br/><br/>\n";
      echo "<input type=\"submit\" class=\"btnLilaAuto\" value=\"Click here\"></center>\n";
