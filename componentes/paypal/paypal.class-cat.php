...
class paypal_class {
   ...
   function submit_paypal_post() {
      ...
      echo "<center><h2>Un momento por favor, su petición se esta procesando";
      echo " estamos redirigiendo su peticion a PayPal.</h2></center>\n";
      ...
      echo "<input type=\"submit\" value=\"Haz click aqui\"></center>\n";
