...
class paypal_class {
   ...
   function submit_paypal_post() {
      ...
      echo "<html>\n";
      echo "<head><title>Processus de paiement PayPal... </title></head>\n";
      echo "<body onLoad=\"document.forms['paypal_form'].submit();\">\n";
      echo "<center><h3>Un moment se il vous plaît, votre demande est en cours sont rediriger votre demande à PayPal.</h3></center>\n";
      ...
      echo "<center><br/><br/>Si pas rediriger vers ";
      echo "Paypal dans 5 secondes... <br/><br/>\n";
      echo "<input type=\"submit\" class=\"btnLilaAuto\" value=\"Cliquez ici\"></center>\n";
