...
class paypal_class {
   ...
   function submit_paypal_post() {
      ...
      echo "<html>";
      echo "<head><title>Proceso de pago por PayPal...</title></head>\n";
      echo "<body onLoad=\"document.forms['paypal_form'].submit();\">\n";
	  echo "<div style=\"visibility: hidden; height: 0px; padding: 0px; margin: 0px;\">";
      echo "<center><h3>Un momento por favor, su petición se está procesando";
      echo " estamos redirigiendo su peticion a PayPal.</h3></center>\n";
      ...
      echo "<center><br/><br/>Si no funciona la redirección a ";
      echo "Paypal en 5 segundos...<br/><br/>\n";
      echo "<input id=\"submitButton\" type=\"submit\" value=\"Haz click aqui\" class=\"btnLilaAuto\"></center>\n";
      echo "</form>\n";
	  echo "</div>";
      echo "</body></html>\n";
