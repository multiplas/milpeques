var noobSlide=new Class({initialize:function(a){this.items=a.items;
...
this.onWalk=a.onWalk||null;this.currentIndex=null;
this.previousIndex=null;this.nextIndex=null;
