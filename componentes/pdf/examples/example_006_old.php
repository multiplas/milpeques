...
'<table style="border: solid 1px #333; padding: 15px;">
	<thead>
		<tr>
			<th rowspan="2"><img src="'.$_SESSION['factura']['logo'].'" alt="" /></th>
...
<table style="border: solid 1px #333; padding: 4px;">
	<tr>
		...
		<td style="backgrond: #CCC; border-left: solid 1px #333; border-bottom: solid 1px #333; text-align: right;"><strong>€/Uni</strong></td>
		<td style="backgrond: #CCC; border-left: solid 1px #333; border-bottom: solid 1px #333;"><strong>Cantidad</strong></td>
		<td style="backgrond: #CCC; border-left: solid 1px #333; border-bottom: solid 1px #333; text-align: right;"><strong>Total (€)</strong></td>
	</tr>';
	...
	foreach($_SESSION['productos'] AS $producto)
	{
		...
		'<tr style="background: '.$colorrw.';">
			<td style="border-left: solid 1px #333;"><strong>'.$producto['nombre'].'</strong>'.($producto['talla']!=null ? '<br>'.$producto['talla'] : '').($producto['extra']!=null ? '<br>'.$producto['extra'] : '').'</td>
			<td style="border-left: solid 1px #333; text-align: right;">'.(strcmp($producto['nombre'], 'Tasas Contrareembolso') != 0 ? number_format($producto['precio'], 2, '.', ',') : number_format(($producto['precio']*-1), 2, '.', ',')).'</td>
			<td style="border-left: solid 1px #333; text-align: right;">'.$producto['cantidad'].'</td>
			<td style="border-left: solid 1px #333; text-align: right;">'.(strcmp($producto['nombre'], 'Tasas Contrareembolso') != 0 ? number_format(($producto['precio']*$producto['cantidad']), 2, '.', ',') : number_format(($producto['precio']*$producto['cantidad']*-1), 2, '.', ',')).'&nbsp;&nbsp;&nbsp;&nbsp;</td>
		</tr>';
...
$html .= 
	'<tr>
		...
		<td style="border-left: solid 1px #333; text-align: right;">-'.number_format($_SESSION['factura']['descuento'], 2, '.', ',').'</td>
...
$html .= 
	...
	<tr>
		...
		<td style="border-top: solid 1px #333; text-align: right;">'.$_SESSION['factura']['total'].' €</td>
	</tr>
</table>
';
