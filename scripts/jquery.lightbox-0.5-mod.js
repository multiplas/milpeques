...
(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageLoading:			'/css/_css/_imgages/lightbox-ico-loading.gif',		// (string) Path and the name of the loading icon
			imageBtnPrev:			'/css/_css/_images/lightbox-btn-prev.gif',			// (string) Path and the name of the prev button image
			imageBtnNext:			'/css/_css/_images/lightbox-btn-next.gif',			// (string) Path and the name of the next button image
			imageBtnClose:			'/css/_css/_images/lightbox-btn-close.gif',		// (string) Path and the name of the close btn
			imageBlank:				'/css/_css/_images/lightbox-blank.gif',			// (string) Path and the name of a blank image (one pixel)
