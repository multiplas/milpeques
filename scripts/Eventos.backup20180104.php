...
$(document).ready(
	...
	{
		if ($(window).width() <= 583)
                    $('.producto img').css('height', '100%');
                else if ($(window).width() <= 920)
                    $('.producto img').css('height', $('.producto img').width()*1.5 + 'px');
                else
        ...
        {
            $(this).css('background-color', '<?php echo $colortextogen; ?>');
        });
        $('#grupo-submenu').bind('unfixed.ScrollToFixed', function()
        {
            $(this).css('background', '<?php echo $colortextogen; ?>');
        });
        ...
        $('select#pagarcon').change(
			function ()
			{
			    if ($(this).val() != 'dom' && $(this).val() != 'domm' && $(this).val() != 'fdir')
					$('div#divpagarcon').css('display', 'none');
                            else
					$('div#divpagarcon').css('display', 'block');
                            
                            if ($(this).val() != 'tpv')
					$('div#divpagarcon2').css('display', 'none');
                            else
					$('div#divpagarcon2').css('display', 'block');
                        }
		);
