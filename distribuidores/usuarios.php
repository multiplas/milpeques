										  ...
										  <div class="controls">
											<select id="Provincia2" name="provincia" class="chzn-select span4" required>
												...
												<?php
													...
													{
														?>
															<option value="<?=$listado['id']?>"><?=$listado['ciudad']?></option>
														<?php
													}
												?>
											</select>
											  ...
											  <div class="controls">
												<select id="Provincia" name="provincia" class="chzn-select span4" required>
													...
													<?php
														...
														{
															?>
																<option value="<?=$listado['id']?>"<?=($elemento['provincia'] == $listado['id'] ? ' selected' : '')?>><?=$listado['ciudad']?></option>
															<?php
														}
													?>
												</select>
												...
												<?php
													foreach ($listados AS $listado)
													{
														...
														<tr class="<?=$lineapi?>">
															...
															<td valign="top" class=""><?=$listado['rol']?></td>
															...
															<td valign="top" class="" style="text-align: center;">
																<a href="?estado=<?=$listado['id']?>"><?=$listado['estado'] == 'A' ? '<i style="color: green;" class="fa fa-check fa-lg"></i>' : ($listado['estado'] == 'R' ? '<i style="color: blue;" class="fa fa-registered fa-lg"></i>' : '<i style="color: #C00;" class="fa fa-times fa-lg"></i>')?></a>
