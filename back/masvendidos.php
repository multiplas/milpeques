                ...
                <div class="span9" id="content">
                    ...
                    <div class="alert alert-info alert-dismissable">
                        ...
                        <h4>MÁS VENDIDO</h4>
                        <p>Esta sección se encarga de los artículos más vendidos. Puede activarlos para que se muestren o desactivarlos, puede elegir automático o manual y seleccionar los más vendidos.</p>
                    </div>
                    <div class="alert alert-danger alert-dismissable">
                        <button type="button" class="close" data-dismiss="alert">&times;</button>
                        <h4>Esta sección se muestra arriba de novedades.</h4>
                    </div>
                     ...
                     <div class="row-fluid">
						<div id="add" class="block" style="height: 0px; visibility: hidden;">
							<div class="navbar navbar-inner block-header">
								<div class="muted pull-left">Añadir artículo más vendido</div>
							</div>
							<div style="padding-bottom:250px;" class="block-content collapse in">
								<div class="span12">
									<form action="masvendidos.php?accion=subirmv" method="post" class="form-horizontal" enctype="multipart/form-data">
									  <fieldset>
										<legend>Añadir artículo más vendido</legend>
										<div class="control-group">
										  ...
										  <div class="controls">
											...
											<span style="color: red; font-size: 0.70rem;">Requerido</span>
                                                                                ...
                                                                                <button type="button" onclick="location.href = 'masvendidos.php';" class="btn" style="position: absolute; bottom: 0px; left: 80px">Cancelar</button>
									  </fieldset>
									</form>
								</div>
							</div>
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                ...
                                <h4 class="modal-title" id="myModalLabel">ELIMINAR MÁS VENDIDO</h4>
                              </div>
                        ...
                        <div class="block">
                            ...
                            <form action="masvendidos.php?accion=mvopciones" method="post" class="form-horizontal" enctype="multipart/form-data">
                            <div class="block-content collapse in">
                                <div class="control-group">
                                    <label class="control-label" for="mv_act">Mostrar</label>
                                    <div class="controls">
                                        <select id="mv_act" name="mv_act" class="">
                                            <option value="0" <?=($elemento['masvendido'] == 0 ? ' selected' : '')?>>No</option>
                                            <option value="1" <?=($elemento['masvendido'] == 1 ? ' selected' : '')?>>Sí</option>
                                        </select><br>
                                        <span style="color: #09F; font-size: 0.70rem;">Mostrar o no los más vistos en la web.</span>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="mvmodo">Modo</label>
                                    <div class="controls">
                                        <select id="mvmodo" name="mvmodo" class="">
                                            <option value="0" <?=($elemento['mvmodo'] == 0 ? ' selected' : '')?>>Automático</option>
                                            <option value="1" <?=($elemento['mvmodo'] == 1 ? ' selected' : '')?>>Manual</option>
                                        </select><br>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select id="posicion" name="posicion" class="">
                                            <option value="0" <?=($elemento['mvposicion'] == 0 ? ' selected' : '')?>>Debajo Slider</option>
                                            <option value="1" <?=($elemento['mvposicion'] == 1 ? ' selected' : '')?>>Encima Slider</option>
                                        </select><br>
                                        <span style="color: #09F; font-size: 0.70rem;">Elija la posición en que desea que se muestre.</span>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="textomv">Texto Más Vendidos</label>
                                    <div class="controls">
                                        <input class="span6" type="text" name="textomv" id="textomv" value="<?=$elemento['textomv']?>" placeholder="Texto Más Vendidos"><br>
                                        <span style="color: #09F; font-size: 0.70rem;">Texto que se mostrará en la cabecera de más vendidos. Para usar texto por defecto dejar en blanco.</span>
                                    </div>
                                </div>
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Listado de Más Vendidos</div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
                                   <div class="table-toolbar">
                                      <div class="btn-group">
                                         <a href="#subirco" onclick="javascript: $('#add').css('height', 'auto'); $('#add').css('visibility', 'visible');"><button class="btn btn-success">Añadir a Más Vendido <i class="icon-plus icon-white"></i></button></a>
                                      </div>
