                                            ...
                                            <tbody role="alert" aria-live="polite" aria-relevant="all">
												<?php
													foreach ($listados AS $listado)
													{
														...
														?>
														<tr class="<?=$lineapi?>">
															<td valign="top" class=""  style="text-align: center;"><?=$listado['Code']?></td>
															<td valign="top" class="" ><?=$listado['Name']?></td>
															<td valign="top" class="" ><?=$listado['Continent']?></td>
															<td valign="top" class="" ><?=$listado['activo'] == 1 ? 'activo' : 'oculto'?></td>
															<td valign="top" class=""  style="text-align: center;">
																<a href="?estadopais=<?=$listado['Code']?>"><?=$listado['activo'] == 1 ? '<i style="color: green;" class="fa fa-check fa-lg"></i>' : '<i style="color: red;" class="fa fa-times fa-lg"></i>'?></a>
															</td>
														</tr>
														<?php
													}
