                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                   <!--<div class="table-toolbar">
											...
											<tbody>
												<?php
													foreach ($listados AS $listado)
													{
														?>
														<tr>
															<td style="text-align: center;"><?=date("Y", strtotime($listado['fecha']))?><?=$listado['id']?></td>
									...
									<?php } else { ?>
										<p>No hay detalles de los productos en el RMA indicado!</p>
									<?php } ?>
                                    <button type="button" onclick="location.href = 'rma.php';" class="btn">Volver</button>
                                </div>
                            </div>
                        </div>
                        <!-- /block -->
