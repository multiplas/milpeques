        ...
        max-height: 100px !important;
                ...
                <div class="span9" id="content">
                     ...
                     <div class="row-fluid">
						<div id="add2" class="block" style="height: 0px; visibility: hidden;">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                    <form action="portes3.php?accion=subirprt3" method="post" class="form-horizontal" enctype="multipart/form-data">
                                      <fieldset>
                                        ...
                                        <br /><br />
                                         <label>Precio € </label> <input type="text" name="precioE" id="precioE" value="" placeholder="Precio"  style="width:35%;" />
                                        <br /><br />
					<button type="submit" class="btn btn-primary">Añadir</button>
					<button type="button" onclick="location.href = 'portes3.php';" class="btn">Cancelar</button>
                                      </fieldset>
									</form>
								</div>
							</div>
						...
						<div id="add3" class="block" style="height: 0px; visibility: hidden;">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                    <form action="portes3.php?accion=subiragen3" method="post" class="form-horizontal" enctype="multipart/form-data">
                                      <fieldset>
					...
					<button type="button" onclick="location.href = 'portes3.php';" class="btn">Cancelar</button>
                        ...
                        <?php if (@$elemento != null && $resultaop != 1 && $_GET['modificaridt'] != null) { ?>
                    <div class="row-fluid">
						<div id="add4" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                    <form action="portes3.php?accion=smodificarpd" method="post" class="form-horizontal" enctype="multipart/form-data">
                                      <fieldset>
                                          <b><?=$elemento['nombre']?></b>
                                        <input type="hidden" name="accion" value="modificarPorte" />
                                        <input type="hidden" name="idt" id="idt" value="<?=$_GET['modificaridt']?>">
                                        <br /><br />
										...
										<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example2">
											...
											<tbody>
                                                                                            <tr>
                                                                                                ...
                                                                                                <td><?=$listados3[$listado11['id']]['precio']?>€ <a href="?modificaridt=<?=$listado11['id']?>"><i class="fa fa-pencil fa-lg"></i></a></td>
                                                                                                <?php } ?>
                                                                                            </tr>
												<?php 
