                ...
                <div class="span9" id="content">
                    <div class="alert alert-info alert-dismissable">
                        ...
                        <p>Esta sección se encarga de crear las categorías a las que pertenecerán los posts.</p>
                    </div>
					<?php if ($resultaop) { ?>
						<div class="row-fluid">
					...
					<?php } ?>
                     <div class="row-fluid">
						<div id="add" class="block" style="height: 0px; visibility: hidden;">
							...
							<div class="block-content collapse in">
								<div class="span12">
									<form action="categorias_blog.php?accion=subircategb" method="post" class="form-horizontal" enctype="multipart/form-data">
									  <fieldset>
										...
										<button type="button" onclick="location.href = 'categorias_blog.php';" class="btn">Cancelar</button>
									  </fieldset>
									</form>
								</div>
							</div>
                     ...
                     <div class="row-fluid">
							<div id="edi" class="block">
								...
								<div class="block-content collapse in">
									<div class="span12">
										<form action="categorias_blog.php?editarcateb=<?=$elemento['id']?>" method="post" class="form-horizontal" enctype="multipart/form-data">
										  <fieldset>
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                ...
                                <h4 class="modal-title" id="myModalLabel">ELIMINAR CATEGORÍA BLOG</h4>
                              </div>
                              <div class="modal-body">
                                ¿Esta seguro de que desea eliminar la categoría blog "<strong><span id="elemento"></span></strong>"?
                              </div>
													...
													foreach ($listadosalt AS $listado)
													{
														...
														<tr class="<?=$lineapi?>">
															...
															<td valign="top" class=""  style="text-align: center;">
																...
																<!--<a href="?eliminarcateb=<?=$listado['id']?>" onclick="return confirm('Desea eliminar la categoría \'\'#<?=$listado['id']?> - <?=$listado['categoria']?>\'\' de la web?');"><i style="color: #C00;" class="fa fa-trash-o fa-lg"></i></a>-->
															</td>
														</tr>
														<?php
													}
